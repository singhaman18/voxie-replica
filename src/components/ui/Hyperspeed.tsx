...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    console.log('Hyperspeed: Container dimensions:', container.offsetWidth, 'x', container.offsetHeight);
    ...
    console.log('Hyperspeed: Canvas created with dimensions:', canvas.width, 'x', canvas.height);

    this.composer = new EffectComposer(this.renderer);
    container.appendChild(this.renderer.domElement);
    
    console.log('Hyperspeed: Canvas created and added to container', canvas);
  ...
  render(delta: number) {
    ...
    // Add a simple test to ensure rendering is working
    if (Math.random() < 0.01) { // Log occasionally
      console.log('Hyperspeed: Render called, delta:', delta);
    }
  }
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  useEffect(() => {
    console.log('Hyperspeed: Starting initialization...');
    ...
    if (!container) {
      console.log('Hyperspeed: No container found');
      return;
    }
    ...
    try {
      ...
      myApp.loadAssets().then(() => {
        console.log('Hyperspeed: Assets loaded, initializing app...');
        myApp.init();
      }).catch((error) => {
      ...
      console.error('Hyperspeed: Error during initialization:', error);
    }
